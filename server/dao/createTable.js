...
function create_table() {
    connection.query(
        "CREATE TABLE IF NOT EXISTS facturacion(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, nombre_articulo VARCHAR(80) NOT NULL, precio DOUBLE NOT NULL, fecha DATE, dni VARCHAR(100), nombre_y_apellido VARCHAR(400) NOT NULL);",
...
function create_factura(factura) {
    connection.query(
        "INSERT INTO facturacion (nombre_articulo, precio, fecha, dni, nombre_y_apellido) VALUES" +
        "(" +
...
function create_articulo(factura) {
    connection.query(
        "INSERT INTO articulos (nombre_articulo, talle, color, cantidad) VALUES" + "(" + convert_to_string(factura.nombre_articulo) + "," +
