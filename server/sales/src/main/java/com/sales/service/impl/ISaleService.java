...
import com.sales.mapper.PurchaseMapper;
...
public class ISaleService implements SaleService {
    ...
    public List<PurchaseDto> getSalesBetweenDates(String startDate, String endDate) {
        ...
        return repo.getSalesBetween(start, end).stream().map(PurchaseMapper::toDto).toList();
    }

    public String saveSales(List<PurchaseDto> purchaseList){
...
//        productRepo.saveAll(products);
    ...
    public ResponseEntity<byte[]> generateExcelReport(String startDate, String endDate) {
        ...
        getSalesBetweenDates(startDate, endDate).forEach(purchase -> {
